...
export const colors = defineSemanticTokens.colors({
  ...
  default: {
    contrast: {
      value: {
        _light: "{colors.default.50}",
        _dark: "{colors.default.900}",
      },
    },
    fg: {
      value: {
    ...
    subtle: {
      value: {
        _light: "{colors.default.100}",
        _dark: "{colors.default.100}",
      },
    },
    muted: {
      value: {
        _light: "{colors.default.800}",
        _dark: "{colors.default.200}",
      },
    },
    emphasized: {
      value: {
    ...
    solid: {
      value: {
        _light: "{colors.default.900}",
        _dark: "{colors.default.50}",
      },
    },
    focusRing: {
      value: {
        _light: "{colors.default.400}",
        _dark: "{colors.default.400}",
      },
    },
  },
})
